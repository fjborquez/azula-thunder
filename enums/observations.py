...
class ObservationsEnum(Enum):
    ...
    UPDATE_QUANTITY_BY_MERGE = ("[USER ACTION]: QUANTITY HAS BEEN UPDATED FROM ${OLD_QUANTITY} ${UOM_DESCRIPTION} TO "
                                "${NEW_QUANTITY} ${UOM_DESCRIPTION} FROM INVENTORY_ID = {$OTHER_INVENTORY_ID}")
